...
const api: DugoutApi = {
  ...
  reviseDraft: (key, feedback) => ipcRenderer.invoke(CHANNELS.reviseDraft, key, feedback),
  editSpecDraft: (key, specId, markdown) => ipcRenderer.invoke(CHANNELS.editSpecDraft, key, specId, markdown),
